...
\begin{document}
	...
	\subsection{Naglasak u osnovnim oblicima nadjeva}
	...
	Pravilo kod さ oblika nadjeva je da naglasak dolazi 1 m\=oru prije さ, osim tamo gdje ta m\=ora ne može nositi naglasak (tada 2 m\=ore prije), te u \textit{heiban} nadjevima, gdje naglasak ostaje nepromijenjen (\textit{heiban}).
	Tako imamo:
	\begin{itemize}
	...
	\subsection{Naglasak osnovnih oblika idjeva}
	Idjevi su, za razliku od nadjeva, pravilna vrsta riječi.
	Razlikujemo ih od nadjeva po tom što imaju nastavak い koji se također mijenja kako se mijenja gramatički oblik idjeva.
	
	\subsection{Naglasak negativnih oblika pridjeva}
