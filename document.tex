...
\begin{document}
	...
	Volicionalni oblici kopule \pitch{だ/0,ろ/1,う/0} i \pitch{で/0,し\m{ょ}/1,う/0}, te hipotetski oblik \pitch{な/1,ら/0,ば/0} mogu se uzeti kao da su \textit{nakadaka}, odnosno \textit{atamadaka}, s naglaskom kako je naznačeno.
	Pri spajanju s \textit{heiban} riječima naglasak preuzima だろう ili でしょう, a pri spajanju s ostalim tipovima naglasaka naglasak ostaje na riječi s kojom se spaja (na isti način i ならば):
	\begin{itemize}
	...
	Imenica također pripada istoj naglasnoj cjelini ako je pridjev nenaglašen (\textit{heiban}), a ako je naglašen tada imenica ulazi u zasebnu naglasnu cjelinu.
	Primjeri:
	\begin{itemize}
		\item \pitch{す/0,て/1,き/1}＋\pitch{な/1}＋\pitch{せ/0,ん/1,せ/1,い/0}＝\pitch{す/0,て/1,き/1,な/1,せ/1,ん/1,せ/1,い/0}（素敵な先生）
